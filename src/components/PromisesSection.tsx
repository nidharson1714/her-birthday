...
export function PromisesSection() {
  ...
  return (
    <section ref={containerRef} className="py-32 px-6 relative z-20 w-full" style={{ background: '#2F4F4F' }} id="promises">
      ...
      <div className="max-w-5xl mx-auto relative z-10">
        ...
        <h2 className="font-headline text-4xl sm:text-6xl mb-24 max-w-2xl text-parchment leading-tight italic overflow-hidden">
          ...
          {promises.map((prom, index) => (
             ...
             >
               ...
               {index === 0 && <div className="absolute top-0 left-0 right-0 h-[1px]" style={{ background: 'linear-gradient(90deg, transparent, rgba(233,193,118,0.3), rgba(233,193,118,0.5), rgba(233,193,118,0.3), transparent)' }} />}
                ...
                <div className="promise-numeral font-headline text-2xl md:text-3xl text-gold-accent italic min-w-[3rem]">
                  {['i', 'ii', 'iii', 'iv', 'v', 'vi'][index]}.
                </div>
                <div className="font-body text-lg sm:text-xl text-parchment-dim leading-relaxed max-w-3xl">
