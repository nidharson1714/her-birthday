...
export function ClosingSection() {
  ...
  return (
    <section ref={containerRef} className="py-40 px-6 min-h-screen bg-parchment relative z-20 w-full flex flex-col items-center justify-center text-center parchment-texture overflow-hidden">
      ...
      <p className="close-greeting font-headline text-4xl sm:text-5xl text-on-surface-variant mb-4 italic">Happy Birthday,</p>
      <h1 className="close-name font-headline text-6xl sm:text-[10rem] text-ink italic mb-16">Harini.</h1>
      ...
      {/* Footer & Contacts */}
      <div className="close-footer absolute bottom-12 w-full flex flex-col items-center gap-10">
        <div className="flex flex-col items-center gap-4">
          <div className="flex gap-10 items-center font-label text-[10px] tracking-[0.4em] uppercase text-outline">
            ...
            <div className="w-[1px] h-3 bg-outline/20" />
